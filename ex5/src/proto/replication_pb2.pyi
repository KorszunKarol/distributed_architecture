...
class Operation(_message.Message):
    __slots__ = ("type", "key", "value", "timestamp")
    class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        READ: _ClassVar[Operation.Type]
        WRITE: _ClassVar[Operation.Type]
    READ: Operation.Type
    ...
    value: int
    timestamp: int
    def __init__(self, type: _Optional[_Union[Operation.Type, str]] = ..., key: _Optional[int] = ..., value: _Optional[int] = ..., timestamp: _Optional[int] = ...) -> None: ...
...
class LayerSyncNotification(_message.Message):
    __slots__ = ("source_layer", "target_layer", "updates", "update_count", "sync_timestamp")
    ...
    update_count: int
    sync_timestamp: int
    def __init__(self, source_layer: _Optional[int] = ..., target_layer: _Optional[int] = ..., updates: _Optional[_Iterable[_Union[DataItem, _Mapping]]] = ..., update_count: _Optional[int] = ..., sync_timestamp: _Optional[int] = ...) -> None: ...
